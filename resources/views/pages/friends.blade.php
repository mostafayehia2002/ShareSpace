                ...
                <tr>
                    ...
                    <td>
                        ...
                        @if ($user->is_friends)
                            ...
                            <a class="btn btn-danger" href="{{ route('user.remove_friend',['id'=> $user->id]) }}"
                               title="Remove Friend">
                        ...
                        @elseif ($user->have_request)
                            ...
                            <a class="btn btn-danger" href="{{ route('user.decline_request',['id'=> $user->id]) }}"
                               title="Decline">
                                <i class="fa-solid fa-user-slash"></i>
                                <span>Decline</span>
                            </a>
                            <a class="btn btn-success" href="{{ route('user.accept_request',['id'=> $user->id]) }}"
                               title="Accept">
                        ...
                        @elseif ($user->sent_a_request)
                            ...
                            <a class="btn btn-warning" href="{{ route('user.cancel_request',['id'=> $user->id]) }}"
                        ...
                        @else
                            ...
                            <a class="btn btn-secondary" href="{{ route('user.send_request',['id'=> $user->id]) }}"
